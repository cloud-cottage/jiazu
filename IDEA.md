...
聚合导航首页，浏览全部上线家族数字馆
1.3 边界（严格遵守个人备案约束）
✅允许：匿名访客只读；管理员 + 邀请协作者后台维护；邮件接收史料投稿；GEDCOM/.gramps 导入导出
❌禁止：公网用户注册；留言、BBS 论坛；线上支付；宗亲组织相关功能；DNA 族谱匹配。
2 域名、路由与访问规则
2.1 域名清单
表格
域名	用途
...
协作者账号：由管理员后台邮箱邀请创建；可分配指定 tree 读写权限；不能自助注册。
匿名访客：全部网页端普通访问者，只读；在世人物信息自动脱敏。
脱敏强制规则
...
本站为个人发起的家族历史数字研究站点，不属于任何宗亲会、联谊会、社会组织。无理事会，不组织线下聚会，不收取会费，不接受捐赠。
本站致力于家谱、旧谱文献、迁徙史料数字化整理。在世亲属信息全部脱敏保护，不会公开完整生辰、籍贯等隐私。
史料、家谱投稿仅通过公开联系邮箱提交，本站不开放用户注册、发帖留言功能。
合规硬性约束
永远关闭公网注册；协作者只能管理员邮箱邀请。
不做任何 BBS、留言板、评论功能。
不涉及任何收费、交易功能。
在世人物隐私信息强制脱敏。
16 风险清单与规避措施
